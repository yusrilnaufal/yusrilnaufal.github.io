---
title: "Analisis Pengaruh Indeks Pendidikan Terhadap Hasil Persentase Suara Sah Pemilihan Presiden 2014"
...
1. Apakah ada pengaruh signifikan antara indeks pendidikan terhadap hasil pemilihan presiden Indonesia tahun 2014?
2. Bagaimana hubungan antara indeks pendidikan dengan hasil pemilihan presiden Indonesia tahun 2014?
...
* Manfaat Teoritis: 
Hasil penelitian ini dapat menjadi kontribusi dalam literatur ilmu politik dan pendidikan, khususnya dalam konteks pemilihan presiden dan pengaruh indeks pendidikan.
...
: Indeks Pendidikan tiap Provinsi tahun 2014 {tbl-colwidths="[60,40]".bordered}
  
Sumber data: Komisi Pemilihan Umum Republik Indonesia dan Badan Pusat Statistik Indonesia
![Logo KPU](kpu.png){fig-alt="Logo KPU." fig-align="left" width=40%} ![Logo BPS](bps.png){fig-alt="Logo BPS." fig-align="right" width=40%}
...
#### Paslon 01 (Prabowo-Hatta)
![Plot Error Prabowo-Hatta](Rplot error 01.png)

#### Paslon 02 (Jokowi-Jusuf Kalla)
![Plot Error Jokowi-Jusuf Kalla](Rplot error 02.png)
...
$$ di mana $y_t$ adalah Persentase Suara Calon Presiden dan $x_t$ adalah Indeks Pendidikan.
...
Untuk menemukan hubungan antara Indeks Pendidikan dan Persentase Suara Sah Calon Presiden, saya menggunakan OLS dengan menggunakan dua model regresi untuk tiap calon presiden. Sehingga didapat hasil seperti tabel berikut:
...
|:--------------------|:------------:|:--------:|:-------:|:------:|
| Intercept           | 56.11338     | 3.28567  | 17.078  | <2e-16 |
| X                   | 0.10748      | 0.06992  |  1.537  | 0.134  |
| R Squared           | 0.07084      |          |         |        |
...
$$
y_{t}=56.11338 + 0.10748 X + \mu_t
$$
Dari persamaan tersebut, kita bisa menyimpulkan bahwa Indeks Pendidikan sangat berpengaruh terhadap Persentase suara Prabowo-Hatta. Hal ini dapat dinilai dari variabel x nya yang positif. Dari persamaan tersebut kita juga dapat menyimpulkan bahwa Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Prabowo-Hatta akan naik 0.10748.

#### Paslon 02 (Jokowi-Jusuf Kalla)
| Variable            | Coefficient  |Std. error| t-value | Prob(.)|
|:--------------------|:------------:|:--------:|:-------:|:------:|
| Intercept           | 66.86186     | 3.90270  | 17.132  | <2e-16 |
| X                   | -0.10748     | 0.06992  | -1.537  | 0.134  |
| R Squared           | 0.07084      |          |         |        |
| Adjusted R Squared  | 0.04086      |          |         |        |
| F Statistic         | 2.363        |          |         |        |
...
Hasil Regresi tersebut dimasukkan ke dalam rumus persamaan sehingga:
$$
y_{t}= 66.86186 + (-0.10748 X) + \mu_t
$$
Dari persamaan tersebut, kita bisa menyimpulkan bahwa Indeks Pendidikan juga sangat berpengaruh terhadap Persentase suara Jokowi-Jusuf Kalla. Dari persamaan tersebut kita dapat menyimpulkan bahwa Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Jokowi-Jusuf Kalla akan turun sebesar 0.10748.

### Metode Kedua 'package (car)'
...
$$
Dari persamaan yang dihasilkan dengan metode kedua, kita bisa menyimpulkan bahwa Indeks Pendidikan sangat berpengaruh terhadap Persentase suara Prabowo-Hatta. Hal ini dapat dinilai lagi dari variabel x nya yang positif. Dari persamaan tersebut kita juga dapat menyimpulkan bahwa Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Prabowo-Hatta akan naik 0.6590.
...
$$
Dari persamaan tersebut, kita bisa menyimpulkan bahwa Indeks Pendidikan juga sangat berpengaruh terhadap Persentase suara Jokowi-Jusuf Kalla. Dari persamaan tersebut kita dapat menyimpulkan bahwa Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Jokowi-Jusuf Kalla akan turun sebesar 0.6590.
...
### Paslon 01 (Prabowo-Hatta)
1. Dengan menggunakan metode pertama, Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Prabowo-Hatta akan naik 0.10748.

2. Dengan menggunakan metode kedua, Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Prabowo-Hatta akan naik 0.6590.
 
### Paslon 02 (Jokowi-JK)
1. Dengan menggunakan metode pertama, Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Jokowi-Jusuf Kalla akan turun sebesar 0.10748.

2. Dengan menggunakan metode kedua, Tiap indeks pendidikan naik 1 poin, Maka Persentase Perolehan suara Jokowi-Jusuf Kalla akan turun sebesar 0.6590.
...
### Rekomendasi
1. Strategi Kampanye: Pasangan calon nomor urut 1 (Prabowo-Hatta) mungkin perlu mempertimbangkan strategi kampanye yang lebih menargetkan pemilih dengan tingkat pendidikan yang lebih tinggi seperti D.I Yogyakarta, DKI Jakarta, Kepulauan Riau dan Aceh, mengingat hasil pemilihan mereka tampaknya lebih baik di antara kelompok ini. Sebaliknya, pasangan calon nomor urut 2 (Jokowi-Jusuf Kalla) mungkin perlu mempertimbangkan strategi kampanye yang lebih menargetkan pemilih dengan tingkat pendidikan yang lebih rendah seperti Papua, Kalimantan Barat, Sulawesi Barat, Jawa tengah dan Papua Barat.

2.  Hasil ini menunjukkan pentingnya pendidikan dalam pemilihan presiden. Oleh karena itu, kedua pasangan calon mungkin perlu mempertimbangkan bagaimana mereka bisa mendukung pendidikan publik dalam strategi kampanye mereka.

3. Meskipun hasil analisis ini menarik, penting untuk diingat bahwa banyak faktor lain yang mempengaruhi hasil pemilihan presiden. Oleh karena itu, mungkin perlu dilakukan analisis lebih lanjut untuk memahami pengaruh faktor-faktor lain, seperti ekonomi, isu-isu sosial, dan lainnya.

### Hambatan
1. Hasil penelitian ini hanya berlaku untuk tahun 2014 saja.

2. Perlu dilakukan penelitian selanjutnya untuk mengetahui pengaruh indikator lain terhadap hasil pemilihan presiden.

3. Perlu dilakukan penelitian selanjutnya untuk mengetahui pengaruh indikator pendidikan terhadap hasil pemilihan presiden di negara lain.
