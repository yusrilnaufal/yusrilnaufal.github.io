...
![Plot Error Prabowo-Hatta](Rplot%20error%2001.png)

#### Paslon 02 (Jokowi-Jusuf Kalla)

![Plot Error Jokowi-Jusuf Kalla](Rplot%20error%2002.png)
...
regresi untuk tiap calon presiden. Sehingga didapat hasil seperti tabel
berikut:
...
Hal ini dapat dinilai dari variabel x nya yang positif. Dari persamaan
tersebut kita juga dapat menyimpulkan bahwa Tiap indeks pendidikan naik
1 poin, Maka Perolehan suara Prabowo-Hatta akan naik 0.10748.
...
bahwa Tiap indeks pendidikan naik 1 poin, Perolehan
suara Jokowi-Jusuf Kalla akan turun sebesar 0.10748.
...
$$ Dari persamaan yang dihasilkan dengan metode kedua, kita bisa
...
1.  Dengan menggunakan metode pertama, Tiap indeks pendidikan naik 1
    poin, Maka Persentase Perolehan suara Prabowo-Hatta akan naik
    10.748%.

2.  Dengan menggunakan metode kedua, Tiap indeks pendidikan naik 1 poin,
    Maka Persentase Perolehan suara Prabowo-Hatta akan naik 65.9%.

### Paslon 02 (Jokowi-JK)

1.  Dengan menggunakan metode pertama, Tiap indeks pendidikan naik 1
    poin, Maka Persentase Perolehan suara Jokowi-Jusuf Kalla akan turun
    sebesar 10.748%.
